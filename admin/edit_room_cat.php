...
$room_cat_id=$_GET['room_category_id'];

$sql="SELECT * FROM RoomCategory WHERE room_category_id='$room_cat_id'";
...
{ 
    extract($_REQUEST); 
    $result=$user->edit_room_cat($room_cat, $total_rooms, $no_of_beds, $bed_type,$facilities,$price,$room_cat_id);
    if($result)
    {
